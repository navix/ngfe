...
test.describe.skip('Demo:SubForm', () => {
  let kit: PageKit;
  ...
  test('Field 1', async () => {
    ...
    await expect(kit.$('#form-value')).toHaveText(
      ' FORM_VALUE: { "field1": "", "subForm": { "subField1": "" } }  ',
    );
    await kit.$('#field1').fill('aaa');
    await expect(kit.$('#form-value')).toHaveText(
      ' FORM_VALUE: { "field1": "aaa", "subForm": { "subField1": "" } } ',
    );
  });
  ...
  test('Sub Field 1', async () => {
    ...
    await expect(kit.$('#form-value')).toHaveText(
      ' FORM_VALUE: { "field1": "aaa", "subForm": { "subField1": "bbb" } } ',
    );
  });
  ...
  test('Sub Field 2', async () => {
    ...
    await expect(kit.$('#form-value')).toHaveText(
      ' FORM_VALUE: { "field1": "aaa", "subForm": { "subField1": "bbb", "subField2": 123 } } ',
    );
  });
});
